...
const skills = [
  ...
  },
  {
    ...
    title: "Bootstrap",
    description: "Experienced in building responsive UIs with Bootstrap components and utility classes."
  },
  {
    icon: "fab fa-css3-alt",
    title: "CSS",
    description: "Strong grasp of modern CSS, Flexbox, Grid, and animations."
  },
  {
    icon: "fas fa-database",
    title: "SQL",
    description: "Capable of designing and querying relational databases using SQL."
  },
  {
    icon: "fab fa-git-alt",
    title: "Git",
