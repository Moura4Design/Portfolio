      ...
      <div className='container d-flex justify-content-center mt-5'>
        <div className='card mt-4' style={{ width: "33rem" }}>
          ...
          <div className='card-body'>
            ...
            <a href="/C.V.pdf" download className="btn btn-sm mb-3 btn-color">
              Download
            </a>
            ...
            <p><a className='nav-link link-hover' target="_blank" rel="noopener noreferrer" href='https://bitbucket.org/TaniaMoura/workspace/repositories/'>bitbucket</a></p>
            <p><i className="bi bi-behance me-2" /><a className='nav-link link-hover' target="_blank" rel="noopener noreferrer" href='https://www.behance.net/Moura_design'>behance</a></p>
          </div>
        </div>
      </div>
    </React.Fragment>
